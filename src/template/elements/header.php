...
$data = App::SearchInside('header-data');
?>
    ...
    <main class="jst-layout mdl-layout__content mdl-color--grey-10">
        ...
        <div class="mdl-grid">
            <div class="jst-header-content mdl-color--teal mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                ...
                <?php $vote = __('Rate plugin', 'search-inside') ?>
                <div id="jst-stars">
                    <a id="plugin-rating" class="plugin-rating" href="<?= $data['plugin-url-review'] ?>/" title="<?= $vote ?>" target="_blank">
                        <?= $data['plugin-rating'] ?>
                    </a>
                </div>
            </div>
        ...
        <div class="mdl-card__menu">
            ...
            <dialog class="mdl-dialog jst-dialog-content">
                ...
                <div class="mdl-dialog__content">
                    <p class="jst-dialog-subtitle"><?= __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eu bibendum ipsum. Ut vel nunc convallis, eleifend risus ac, ultricies elit. Nam sed lectus nisi. Nam convallis purus at risus suscipit, id placerat purus lobortis. Integer sit amet commodo felis. Sed commodo tempor nunc, ut ullamcorper elit ornare non. Aliquam vestibulum, nulla eget ultricies ullamcorper, libero felis sollicitudin leo, ut ornare velit mi id sem. Suspendisse potenti.', 'search-inside') ?>
                    </p><br>
                    <p class="jst-dialog-subtitle"><?= __('Sed lobortis rhoncu', 'search-inside') ?> <a href="<?= $data['plugin-url-review'] ?>/" target="_blank"><?= __('feedback', 'search-inside') ?></a> <?= __('lorem ipsum dolor sit amet, consectetur adipiscing elit', 'search-inside') ?>
