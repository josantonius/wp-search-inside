		...
		<div class="mdl-grid">
			<div class="jst-header-content mdl-color--teal mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
				<h2 class="jst-header-title mdl-card__title-text">
					<?php echo __( 'Search Inside', 'search-inside' ); ?>
				</h2>
				<?php echo Hook::doAction( 'wp-plugin-rating\display', $slug ); ?>
			</div>
		</div>
		...
		<div class="mdl-card__menu">
			...
			<dialog class="mdl-dialog jst-dialog-content">
				...
				<div class="mdl-dialog__content">
					<p class="jst-dialog-subtitle"><?php echo __( 'Hi! I\'m Josantonius, the developer of this plugin. I would like to tell you something...', 'search-inside' ); ?>
					</p><br>
					<p class="jst-dialog-subtitle"><?php echo __( 'Did you know that you aren\'t using the free version of the plugin? This is the pro version at no cost to you. Why do I do this? Maybe some can not afford to buy it and I want to prevent it from being downloaded from any place infected with malicious code and ruin your website, I want you to try it freely and I want you to have the opportunity to collaborate on this', 'search-inside' ); ?> <a href="https://github.com/Josantonius/Search-Inside.git/" target="_blank"><?php echo __( 'open source project', 'search-inside' ); ?></a> <?php echo __( 'if you want it.', 'search-inside' ); ?>
					</p><br>
					<p class="jst-dialog-subtitle"><?php echo __( 'Your contribution and', 'search-inside' ); ?> <a href="https://wordpress.org/support/plugin/search-inside/reviews/#new-post/" target="_blank"><?php echo __( 'feedback', 'search-inside' ); ?></a> <?php echo __( 'will help me keep updated and keep developing new versions for this plugin. Thank you!', 'search-inside' ); ?>
				...
				<div class="mdl-dialog__actions">
					<button type="button" class="mdl-button close">
						<?php echo __( 'CLOSE', 'search-inside' ); ?>
					</button>
				</div>
